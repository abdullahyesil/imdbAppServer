        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    h1Name = table.Column<string>(type: "text", nullable: true),
                    surveys = table.Column<bool>(type: "boolean", nullable: false),
                    surveyId = table.Column<int>(type: "integer", nullable: true),
                    imdbAppStory = table.Column<bool>(type: "boolean", nullable: false),
                    imdbAppStoryId = table.Column<List<int>>(type: "integer[]", nullable: true),
                    carousel = table.Column<bool>(type: "boolean", nullable: false),
                    carouselId = table.Column<List<int>>(type: "integer[]", nullable: true),
                    carouselBaslik = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "carousel", "carouselBaslik", "carouselId", "h1Name", "imdbAppStory", "imdbAppStoryId", "surveyId", "surveys" },
                values: new object[] { 1, true, "Popüler Filmler", new List<int> { 2, 1 }, "", true, new List<int> { 1, 2 }, 2, true });
